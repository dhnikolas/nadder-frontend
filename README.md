...
При создании нового тега (версии) GitHub Actions автоматически:
1. Соберет приложение для macOS
2. Создаст релиз на GitHub
3. Загрузит собранные файлы (.dmg и .zip) в релиз
...
2. GitHub Actions автоматически запустится и создаст релиз

3. После завершения сборки релиз будет доступен на странице Releases в GitHub

**Формат тега:** `v*` (например: `v1.0.0`, `v1.0.1`, `v2.0.0`)
